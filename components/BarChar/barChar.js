...
function BarChart(props) {
    ...
    const { rateBusi, setRateBusi ,Lang, setLang, arrayLang } = useBetween(state.useShareState);
    ...
    var colorRange = ['#88c0ee', '#70b6f0', '#5da8e6'];
    ...
    return (
        ...
        <div className='chartCont' style={{direction:"rtl"}}>
            <p>{props.text=="barChar2" ?  arrayLang.MoneyReceived :arrayLang.CompletedRequests }</p>
